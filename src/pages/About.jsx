    ...
    <div className="flex items-center justify-center sm:justify-start gap-1 bg-zinc-100 dark:bg-zinc-900/80 p-1 rounded-lg font-mono text-xs w-full sm:w-auto">
      {categories.map((cat) => (
        <button
          ...
          className={`flex-1 sm:flex-none px-3 py-1.5 rounded-md transition-all text-center ${activeTab === cat
          ...
          <div className="md:col-span-2 space-y-10 relative">
            ...
            {filteredLogs.map((log) => (
              <article key={log.id} className="relative pl-10 space-y-3 group">
                ...
                {/* ENTRY METADATA */}
                <div className="flex items-center text-xs font-mono text-zinc-400 pt-0.5">
