...
export default function Footer() {
  ...
  return (
    // 1. Binago ang main container background, text, at perimeter borders
    <footer 
      className="bg-white dark:bg-zinc-900 text-gray-900 dark:text-zinc-100 border-t border-gray-100 dark:border-zinc-800 py-16 px-8 md:px-16 relative overflow-hidden transition-colors duration-200"
    ...
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
        ...
        <div className="md:col-span-6 flex items-center">
          <div className="relative w-90 h-50 flex items-center justify-center">
            {/* 2. Dinagdagan ng `dark:invert` para maging white ang logo kapag gabi */}
            <img 
              src="/my-logo.png" 
              alt="Khen Logo" 
        ...
        <div className="md:col-span-6 grid grid-cols-2 gap-8 md:justify-items-start">
          ...
          <div className="space-y-4">
            {/* 3. Dinagdagan ng `dark:text-white` ang headers */}
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              {/* 4. Nilagyan ng dark responsive design variants ang lahat ng social box links (bg, borders, hover states) */}
              {/* Facebook */}
              <a 
                href="https://facebook.com/khenqt" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-11 h-11 bg-white dark:bg-zinc-800 border border-gray-100 dark:border-zinc-700 rounded-xl flex items-center justify-center text-gray-700 dark:text-zinc-300 shadow-[0_4px_12px_rgba(0,0,0,0.03)] hover:text-[#1877F2] dark:hover:text-[#1877F2] hover:border-[#1877F2]/20 hover:scale-105 transition-all duration-200"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="w-11 h-11 bg-white dark:bg-zinc-800 border border-gray-100 dark:border-zinc-700 rounded-xl flex items-center justify-center text-gray-700 dark:text-zinc-300 shadow-[0_4px_12px_rgba(0,0,0,0.03)] hover:text-black dark:hover:text-white hover:scale-105 transition-all duration-200"
              >
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
      ...
      {/* ================= BOTTOM BAR ================= */}
      {/* 5. Inayos ang divider line ng bottom bar (`dark:border-zinc-800`) at text color (`dark:text-zinc-500`) */}
      <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-gray-500/10 dark:border-zinc-800 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs font-medium text-gray-400 dark:text-zinc-500 relative transition-colors duration-200">
        ...
        <div className="flex items-center gap-6 pr-0 md:pr-16">
          ...
          <div className="flex items-center gap-1.5 cursor-pointer text-gray-400 dark:text-zinc-500 hover:text-gray-600 dark:hover:text-zinc-300 transition-colors">
            <span>🤍 Like</span>
            <span className="bg-gray-50 dark:bg-zinc-800 border border-gray-100 dark:border-zinc-700 px-1.5 py-0.5 rounded text-[10px] text-gray-900 dark:text-zinc-300">11</span>
          </div>
      ...
      {/* 6. In-adjust ang theme ng floating scroll button (`dark:bg-zinc-100 dark:text-zinc-950 dark:hover:bg-white`) */}
      <button 
        onClick={scrollToTop}
